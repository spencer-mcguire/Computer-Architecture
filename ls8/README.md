...
* CPU.py
  - manages the opporators
    - init needs to be filled out
    - ADD opporator has been implemented
    - SUB needs to be filled out
    - implement RUN
    - day 2 load needs to be changed from hard coded.
    - trace is there to help debug
    - as needed basis may need to add more
* ls8.py
  - invokes the cpu class
    - CPU class called
    - run method called
    - load method called
